...
/*
  Paddle
  - Możliwość poruszania się na boki (przez użytkownika)
  - Zatrzymuje się na krawędzi ekranu
  - Szerokość i wysokość
  - Odbija piłkę
  - Odbija piłkę w różny sposób, w zależności od pozycji, w której została uderzona na wiosle
  ...
  Ball
  - Odbija się od ścian, wiosła i bloków
  - Szerokość i wysokość
  - położenie prędkości

  Block
  - część poziomu
  - Ma HP - Jedno uderzenie piłką to -1 HP
  - Kolor i pozycja, szerokość i wysokość (AARectangle)
  - Odbija piłkę

  Level
  - Pojemnik mieszczący wszystkie klocki
  - Powinno być możliwe załadowanie poziomu z plikulevels.txt
  - Obsługa kolizji bloków?
  - zawierać ściany/krawędzie ekranów
  - Zresetuj poziom

  Game
  - Zawiera wszystkie obiekty (wiosło, piłka, poziomy)
  - Gracz, który ma 3 życia
  - Stany - Podaj piłkę, w grze, koniec gry
  - Zresetuj grę
 */
